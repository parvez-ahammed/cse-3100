      ...
      <div className={styles.formCard}>
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className={styles.formIntro}>
            <h3>Get in Touch</h3>
            <p>Have questions about Rick and Morty? Want to share your theories? We'd love to hear from you!</p>
          </div>
          <div className={styles.formRow}>
            ...
            <div className={styles.formGroup}>
              ...
              <input
                id="name"
                className={`${styles.formControl} ${errors.name ? styles.invalidInput : ""}`}
                type="text"
                name="name"
                value={form.name}
          ...
          <div className={styles.formGroup}>
            ...
            <textarea
              id="message"
              className={`${styles.formControl} ${styles.textarea} ${errors.message ? styles.invalidInput : ""}`}
              name="message"
              rows="5"
              value={form.message}
              onChange={handleChange}
        ...
        <div className={styles.contactInfoSection}>
          <h5 className={styles.contactInfoTitle}>Other Ways to Reach Us</h5>
          <p className={styles.contactInfoSubtitle}>You can also contact us through these channels:</p>
          <div className={styles.contactInfoList}>
            <div className={styles.contactInfoItem}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className={styles.contactIcon} viewBox="0 0 16 16">
